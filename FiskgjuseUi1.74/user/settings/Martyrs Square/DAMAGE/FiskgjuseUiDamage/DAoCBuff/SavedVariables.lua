DAoCBuffVar = 
{
	...
	Tables = 
	{
		...
		[6] = 
		{
			[1760] = 
			{
				effectText = L"You deal additional damage, while hurting yourself",
				name = L"Hurtin' Time^n",
				iconNum = 2648,
			},
			[17051] = 
			{
			...
			[29023] = 
			{
				effectText = L"Movement speed increased by 60%.",
				name = L"Summon Mount^n",
				iconNum = 14783,
			},
			[8269] = 
			{
				effectText = L"Wounds increased by 68.",
				name = L"Sigmar's Grace^n",
				iconNum = 8039,
			},
		},
		HealOutDebuff = 
