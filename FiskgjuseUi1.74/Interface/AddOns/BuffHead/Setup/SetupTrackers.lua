...
local function SetTracker(tracker, trackerType)
	...
	if (tracker.Type == TargetType.Friendly) then
		...
		ComboBoxAddMenuItem(windowName .. "TrackerBuffsList", localization["Setup.Trackers.Friendly.Buffs.CastByOthers"]);
		...
		ComboBoxAddMenuItem(windowName .. "TrackerDebuffsList", localization["Setup.Trackers.Hostile.Debuffs.CastByOthers"]);
	end
