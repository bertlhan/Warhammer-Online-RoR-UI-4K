...
local function LoadEffectsSettings(settings)
	...
	if (settings.Type == BuffHead.TargetType.Hostile) then
		...
		ComboBoxAddMenuItem(windowName .. "DebuffsComboBox", localization["Setup.Trackers.Hostile.Debuffs.CastByOthers"]);
	else
		...
		ComboBoxAddMenuItem(windowName .. "BuffsComboBox", localization["Setup.Trackers.Friendly.Buffs.CastByOthers"]);
