		...
		if (tracker) then
			if (isBuff) then
				...
				elseif (tracker.Buffs == BuffHead.BuffType.Friendly.CastByMe and ability.castByPlayer) then
					displayEffect = true;
				elseif (tracker.Buffs == BuffHead.BuffType.Friendly.CastByOthers and not ability.castByPlayer) then
					displayEffect = true;
				end
		...
		if (tracker) then
			...
			elseif (isDebuff) then
				...
				elseif (tracker.Debuffs == BuffHead.DebuffType.Hostile.CastByMe and ability.castByPlayer) then
					displayEffect = true;
				elseif (tracker.Debuffs == BuffHead.DebuffType.Hostile.CastByOthers and not ability.castByPlayer) then
					displayEffect = true;
				end
			end
		end
