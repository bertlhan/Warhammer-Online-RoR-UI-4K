...
local function copyDefaults(dest, src)
	...
	--d("function copyDefaults(dest, src)");
...
local function removeDefaults(db, defaults, blocker)
	...
	--d("function removeDefaults(db, defaults, blocker)");
...
local function initSection(db, section, svstore, key, defaults)
	...
	--d("function initSection(db, section, svstore, key, defaults)")
...
local function validateDefaults(defaults, keyTbl, offset)
	...
	--d("function validateDefaults(defaults, keyTbl, offset)")
...
local function prepareString(input)
	...
	--d("function prepareString(input)")
...
function GetCareerLineFromId(careerId)
	...
	--d("function GetCareerLineFromId(careerId)")
