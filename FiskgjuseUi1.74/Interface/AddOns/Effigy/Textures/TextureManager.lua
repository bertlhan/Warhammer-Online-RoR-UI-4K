...
Addon.texture_list_local = {
	["FiskgjuseUiCross"] = { scale = 1, width=680, height=680 },
	["FiskgjuseUiStar"] = { scale = 1, width=117, height=117 },
	["FiskgjuseGradientH"] = { scale = 1, width=260, height=4 },
	["FiskgjuseGradientV"] = { scale = 1, width=4, height=260 },
