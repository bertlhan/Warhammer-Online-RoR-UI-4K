...
## What's Changed
All UI element dimensions, positions, and coordinates in the Lua configuration files have been multiplied by 2.0 to scale from HD (1920x1080) to 4K (3840x2160) resolution.

### Key Features
- ✅ 94 AddOn files modified with 2.0x scaling
...
2. Copy the `FiskgjuseUi1.74` folder to your Warhammer Online RoR user interface directory
3. Run the game in 4K resolution (3840x2160)
4. Enjoy properly sized UI elements!
